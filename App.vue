<script>
	...
	export default {
		globalData: {  
			serverUrl: "http://47.106.32.19",		// 开发环境，不能使用localhost
		...
		onLaunch: function() {
			...
			uni.onTabBarMidButtonTap(()=>{
				...
				uni.chooseVideo({
					...
					success(e) {
						console.log(e);
						// const  tempFile = {...e.tempFile}
						// console.log(tempFile)
						console.log(e.tempFilePath)
						// console.log(typeof data.tempFile);
						const tempFilePath=e.tempFilePath
						console.log(JSON.stringify(e.tempFilePath));
						// console.log(JSON.stringify(e.tempFile));
						...
						uni.navigateTo({
							url: "/pages/publish/publish?fileObjectEvent="+JSON.stringify(e)+"&tempFilePath="+JSON.stringify(e.tempFilePath)
						})
